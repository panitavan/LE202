...
Raspberry Pi เลข 2 ถัดมาคือจำนวน Core ของ MCU และเลข 0 ในหลักถัดมาคือชนิดของ Arm Core นั้นเอง เลข 4 ตัวต่อมาคือจำนวนของ RAM เลขสุดท้ายคือจำนวนของ Flash Memory ซึ่งใน RP2040 ไม่ได้ใส่มาเลขได้เลขเป็น 0
